...
void cpp_step(
    ...
    nb::ndarray<double, nb::ndim<1>, nb::c_contig, nb::device::cpu> Fh_buf,
    nb::ndarray<double, nb::ndim<1>, nb::c_contig, nb::device::cpu> Fhu_buf,
...
NB_MODULE(swe_step, m) {
    ...
    m.def("cpp_step", &cpp_step,
          ...
          nb::arg("Fh").noconvert(), nb::arg("Fhu").noconvert(),
